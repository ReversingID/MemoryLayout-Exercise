...
Jika sebuah class memiliki satu atau lebih variabel static, dimana ia berada?
...
Kesimpulan:
    ...
    Semua instance object akan merujuk ke variabel yang sama, lokasi yang sama,
    dan berlaku selayaknya sebagai data global.
*/
